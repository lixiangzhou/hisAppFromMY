...
+ (NSString *)queryStringFromDictionary:(NSDictionary *)dict
{
    ...
    for ( NSString * key in [dict keyEnumerator] )
    {
        ...
        NSString * urlEncoding = (NSString*)[value URLEncoding];
...
+ (NSString *)tirmDot:(NSString *)str {
    ...
    if (docRange.location == NSNotFound) {
        ...
        IDPLogDebug(@"docRange is %d", (int)docRange.location);
...
- (CGFloat)caleFontWidhSize:(UIFont *)font forViewHeight:(CGFloat)height {
    CGSize size = [self caleFontSize:font forMaxSize:CGSizeMake(CGFLOAT_MAX, height) lineBreakMode:NSLineBreakByTruncatingTail];
    return size.width;
}
