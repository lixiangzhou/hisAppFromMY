...
#define kAnimaterScreenCenterY = [UIScreen mainScreen].bounds.size.height / 2
#define kAnimaterScreenCenterX = [UIScreen mainScreen].bounds.size.width / 2
#define kAnimaterScreenCenter = CGPointMake(kAnimaterScreenCenterX, kAnimaterScreenCenterY)
@interface Animatr : NSObject <UIViewControllerTransitioningDelegate>
/**
 * modalPresentationStyle toVC中设置的转场动画的样式
 */
