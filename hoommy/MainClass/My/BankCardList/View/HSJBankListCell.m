...
@implementation HSJBankListCell
...
- (void)setBankModel:(HSJBankListModel *)bankModel {
...
- (UILabel *)bankNameLabel {
    if (!_bankNameLabel) {
        ...
        _bankNameLabel.textColor = kHXBColor_666666_100;
    }
...
- (UILabel *)bankQuotaLabel {
    if (!_bankQuotaLabel) {
        ...
        _bankQuotaLabel.textColor = kHXBColor_999999_100;
    }
