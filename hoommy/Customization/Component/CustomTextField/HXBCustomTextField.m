...
- (UIButton *)eyeBtn
{
    if (!_eyeBtn) {
        ...
        [_eyeBtn setImage:[UIImage imageNamed:@"password_eye_close"] forState:UIControlStateNormal];
        [_eyeBtn setImage:[UIImage imageNamed:@"password_eye_open"] forState:UIControlStateSelected];
